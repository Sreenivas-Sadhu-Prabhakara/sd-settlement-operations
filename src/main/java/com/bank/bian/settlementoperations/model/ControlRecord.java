package com.bank.bian.settlementoperations.model;
...
/**
 * The BIAN control record for this service domain: "Settlement Instruction Operating Session".
 *
 ...
 * to its asset type (Settlement Instruction). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Settlement Instruction Operating Session";
